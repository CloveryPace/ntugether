      ...
      <div className='responsiveDiv'>
        <Box sx={{ mt: 4, mb: 4}}>
          ...
          > 
            ...
            <LinkTab label={t("揪團紀錄")} href="/#"  selected={selectedTab === 2? true : false}/>
            <LinkTab label={t("進度管理")} href="/#"  selected={selectedTab === 3? true : false}/>
            <LinkTab label={t("帳戶設定")} href="/setting"  selected={selectedTab === 4? true : false}/>
